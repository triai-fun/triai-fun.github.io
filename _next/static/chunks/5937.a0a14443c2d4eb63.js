"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5937],{99282:function(e,t,n){},20070:function(e,t,n){n.d(t,{SIWEController:function(){return o},getDidAddress:function(){return s.NmC},getDidChainId:function(){return s.ZzI}});var i=n(56374);n(21134);var s=n(42701),r=n(55543),a=n(33085);let l=(0,a.sj)({status:"uninitialized"}),o={state:l,subscribeKey:(e,t)=>(0,r.VW)(l,e,t),subscribe:e=>(0,a.Ld)(l,()=>e(l)),_getClient(){if(!l._client)throw Error("SIWEController client not set");return l._client},async getNonce(e){let t=this._getClient(),n=await t.getNonce(e);return this.setNonce(n),n},async getSession(){try{let e=this._getClient(),t=await e.getSession();return t&&(this.setSession(t),this.setStatus("success")),t}catch{return}},createMessage(e){let t=this._getClient().createMessage(e);return this.setMessage(t),t},async verifyMessage(e){let t=this._getClient();return await t.verifyMessage(e)},async signIn(){let e=this._getClient();return await e.signIn()},async signOut(){let e=this._getClient();await e.signOut(),this.setStatus("ready"),this.setSession(void 0),e.onSignOut?.()},onSignIn(e){let t=this._getClient();t.onSignIn?.(e)},onSignOut(){let e=this._getClient();e.onSignOut?.()},setSIWEClient(e){l._client=(0,a.iH)(e),l.status="ready",i.OptionsController.setIsSiweEnabled(e.options.enabled)},setNonce(e){l.nonce=e},setStatus(e){l.status=e},setMessage(e){l.message=e},setSession(e){l.session=e,l.status=e?"success":"ready"}};var c=n(1651),u=n(71815),g=(0,u.iv)`
  :host {
    display: flex;
